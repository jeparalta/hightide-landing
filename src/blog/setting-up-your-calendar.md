...
author: José Paralta
excerpt: Understanding how Items and Listings work on Hightide
image: /assets/images/blog-calendar.jpg
permalink: /post/setting-up-your-calendar/
---
...
> Prefer video? Watch the tutorial: [Understanding Items and Listings](/video-tutorials/).
...
- **Daily based**, for tours, lessons, activities, or similar services
- **Night based**, for accommodations
...
### Examples of Items and Units

**Private Accommodation**

- One double room would be set up as a Night based Item with 1 Unit (Room)
- Five identical private rooms would use a Night based Item with 5 Units (Room)

**Shared Accommodation**

- A dorm with four beds would be configured as a Night based Item with 4 Units (Bed)

**Private Tours or Lessons**

- One instructor offering private lessons would use a Daily based Item with 1 Unit (Lesson)
- A surf school with three instructors could use a Daily based Item with 3 Units (Lesson)

**Group Activities**

- A yoga class for up to eight people would be set up as a Daily based Item with 8 Units (Person)
...
- Date selection (flexible or fixed)
- Pricing, taxes, and booking rules
...
### Using Multiple Listings for One Item
...
- Same Item: Night based Item with 1 Unit (Room)
- Listing Title: Yoga Week - Double Room
- Date selection: Fixed (for example, June 1 to 8)
- Description and Features: Tailored for the retreat
- Pricing and Rules: Custom for this experience
...
### Using Multiple Items for One Listing
...
- Create three Daily based Items (one per instructor)
- Connect them all to one Listing titled “Private Surf Lesson”
...
> Need a walkthrough video? Visit the [Video Tutorials](/video-tutorials/) page to see step-by-step examples in action.
